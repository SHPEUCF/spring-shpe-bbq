export const dayOneData = [
	...
	// },
	{
		...
		shortDesc: 'Gartner equips executives across the enterprise to make the right decisions and stay ahead of change'
	},
	// {
	...
	// },
	{
		...
		shortDesc: "One of the nation's premier planning and design engineering consultants."
	},
	{
		companyName: 'Lockheed Martin',
		logo: require('../assets/images/lockheedLogo.png'),
		shortDesc: "From green energy to aerospace, there are so many ways you can make a difference with us."
	},
	// {
	// 	companyName: 'PwC',
	...
	shortDesc: 'An American corporation that manufactures agricultural, construction, forestry machinery, diesel engines, & more.'
	},
	{
		companyName: 'CDM Smith',
		logo: require('../assets/images/cdmsmithLogo.png'),
		shortDesc: 'CDM Smith is an engineering and construction firm providing smart solutions in water, environment, transportation, energy and facilities.'
	},
	{
		companyName: 'Deloitte',
		logo: require('../assets/images/deloitteLogo.png'),
...
export const dayTwoData = [
	...
	// },
	{
		companyName: 'JPMorgan Chase & Co.',
		logo: require('../assets/images/jpmcLogo.png'),
		shortDesc: 'JPMorgan Chase & Co. is a leading global financial services firm and one of the largest banking institutions in the USA.'
	},
	{
		companyName: 'Enercon',
	...
	{
		companyName: 'Epic',
		logo: require('../assets/images/epic-systems-corporation-vector-logo.svg'),
		shortDesc: 'Epic develops software to help people get well, help people stay well, and help future generations be healthier.'
	},
	{
		companyName: 'Texas Instruments',
		logo: require('../assets/images/tiLogo.png'),
		shortDesc: 'Come change the world with us!'
	},
	// {
	// 	companyName: 'IBM',
